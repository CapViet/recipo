  ...
  export function RecipeForm({ countries, recipe, isUserSubmit = false }: RecipeFormProps) {
    ...
    try {
      // If editing an existing recipea
      if (recipe) {
      ...
      await createRecipe({
        ...data,
        status: isUserSubmit ? "pending" : "approved",
        isFeatured: isUserSubmit ? false : data.isFeatured,
      });

      toast.success("Recipe created successfully");

      if (isUserSubmit) {
        router.push("/recipes/submit/thank-you"); // create this route
      } else {
        router.back(); // admin flow
      }
